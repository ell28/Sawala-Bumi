...
/** Server-only client for storage uploads (requires service role key) */
export const supabaseAdmin: SupabaseClient | null =
  supabaseUrl && supabaseServiceKey
    ? createClient(supabaseUrl, supabaseServiceKey)
    : null;

export const STORAGE_BUCKET = "bookings-media";
// Create bucket "bookings-media" in Supabase Dashboard > Storage, set to Public.
